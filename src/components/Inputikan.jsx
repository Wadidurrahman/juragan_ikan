...
export default function Inputpenjualan({ closePopup }) {
        ...
        <div className="">
          <table className="table-auto bg-slate-200 w-full border-collapse rounded-xl">
            ...
            <tbody>
              ...
              <tr>
                <td className="px-2 py-2 font-semibold border border-white">Nama Kolam</td>
                <td className="px-1 py-2 border border-white">
                  <input className="w-full border p-1 rounded-lg" type="text" placeholder="Masukkan Keterangan" />
                </td>
              </tr>
              <tr>
                <td className="px-2 py-2 font-semibold border border-white">Jenis Ikan</td>
                <td className="px-1 py-2 border border-white">
                  <input className="w-full border p-1 rounded-lg" type="number" placeholder="Masukkan Jumlah" />
                </td>
              </tr>
              <tr>
                <td className="px-2 py-2 font-semibold border border-white">Kondisi Ikan</td>
                <td className="px-1 py-2 border border-white">
                  <input className="w-full border p-1 rounded-lg" type="number" placeholder="Masukkan Stock Ikan" />
                </td>
              </tr>
              <tr>
                <td className="px-2 py-2 font-semibold border border-white">Jumlah Ikan</td>
                <td className="px-1 py-2 border border-white">
                  <input className="w-full border p-1 rounded-lg" type="number" placeholder="Masukkan Harga Ikan" />
                </td>
              </tr>
            </tbody>
          </table>
