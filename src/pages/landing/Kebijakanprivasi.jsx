      ...
      <main>
        <article>
          ...
          <div className="p-8">
            ...
            <p className="px-5 list-disc pl-5">
            ...
            <p className="px-5 list-disc pl-5">Kami mengambil langkah-langkah keamanan yang wajar untuk melindungi informasi pribadi Anda dari akses yang tidak sah, pengungkapan, perubahan, atau penghancuran yang tidak sah.</p>
