...
export default function Pencatatanpakan() {
  ...
  return (
    <>
      <main>
        <div className="p-5 md:p-20 lg:py-20 h-full grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="mt-10 py-10">
            <h2 className="font-bold text-2xl md:text-3xl text-center md:text-left ">Pencatatan Data Pakan</h2>
          </div>
          <div className="lg:mt-20 flex flex-col items-center md:items-end text-center md:text-left">
